...
def parse_argument():
  """ parse the arguments using argparse and return the algorithm and the filename """
...
def implement_nneighbor(city_map):
  """ display the readable nearest neighbor algorithm """
...
def implement_2opt(city_map):
  """ display the readable two opt algorithm """
  print('TWO OPT:')
...
def implement_algorithm(algorithm, city_map):
  """ display the optional algorithm """
